...
REQUESTS = Counter('flask_app_calls_total', 'How many time my app was called')
EXCEPTIONS = Counter('flask_app_exceptions_total', 'How many exceptions my app was raised')
LATENCY = Histogram('flask_app_latency_seconds', 'Time needed for a request')
